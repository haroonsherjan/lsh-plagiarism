...
public class MyTree {
 ...
 public static final String ANCESTOR_STR = "ANCESTOR";
 public static final String DESCENDANT_STR = "DESCENDANT";
 public static final String LEFT_SIBLING_STR = "LEFT SIBLING";
 public static final String RIGHT_SIBLING_STR = "RIGHT SIBLING";
 ...
 public String relationship(int A, int B)
 {
  if (isAncestor(A,B))
   ...
   return DESCENDANT_STR;
  else if (isLeftSibling(A,B))
   return LEFT_SIBLING_STR;
  else if (isLeftSibling(B,A))
   return RIGHT_SIBLING_STR;
  else
   return NONE_STR; //If the nodes have none of the above relationships
