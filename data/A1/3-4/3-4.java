...
public class CitiesDriver {
 ...
 public static void readTree () {
  ...
  treee = new MyTree(nodes);
  
  // Safety
  for (int i=0;i<nodes;i++){ 
   
   
   treee.updateSafe(i, scanner.nextInt() == 1);
  }

  // loop to read pairs of children
  for (int i=0;i<nodes;i++) {
   treee.updateNode(i,scanner.nextInt(),scanner.nextInt());
  }
 }
 ...
 public static void readQueries () {
  ...
  for (int i=0;i<m;i++) {
   if (treee.isPathSafe(scanner.nextInt(),scanner.nextInt()))
